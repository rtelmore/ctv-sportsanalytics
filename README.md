...
-   [wehoop](https://cran.r-project.org/package=wehoop) provides functions for accessing women's 
    college basketball and WNBA data from the [ESPN](https://www.espn.com) API.
-   [hoopR](https://cran.r-project.org/package=hoopR) provides functions for accessing men's 
    college basketball and NBA data from various sources, including [ESPN](https://www.espn.com),
    [NBA Stats API](https://www.nba.com/stats), and [Ken Pomeroy's college basketball ratings](https://www.kenpom.com).
...
-   [cfbfastR](https://cran.r-project.org/package=cfbfastR) provides function for 
    accessing college football play-by-play data from [collegefootballdata.com](https://collegefootballdata.com).
